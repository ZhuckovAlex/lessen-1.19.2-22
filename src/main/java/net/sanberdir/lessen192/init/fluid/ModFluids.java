...
public class ModFluids {
    public static final DeferredRegister<Fluid> FLUIDS =
            DeferredRegister.create(ForgeRegistries.FLUIDS, Lessen192.MOD_ID);
    ...
    public static final ForgeFlowingFluid.Properties SOAP_WATER_FLUID_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .slopeFindDistance(2).levelDecreasePerBlock(2).block(InitBlocksL192.SOAP_WATER_BLOCK)
            .bucket(InitItemsL192.SOAP_WATER_BUCKET);
