package net.sanberdir.lessen192.init.fluid;
...
public class ModFluidTypes {
    ...
    public static final ResourceLocation SOAP_OVERLAY_RL = new ResourceLocation(Lessen192.MOD_ID, "misc/in_soap_water");

    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, Lessen192.MOD_ID);
